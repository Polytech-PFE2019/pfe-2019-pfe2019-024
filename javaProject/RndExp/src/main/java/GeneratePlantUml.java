...
public class GeneratePlantUml {
    ...
    public GeneratePlantUml() throws IOException {
        File file = new File("RndExp/src/main/resources/myUml.txt");
        if (file.exists() && file.isFile())
        {
            file.delete();
        }
        file.createNewFile();
        file = new File("RndExp/src/main/resources/myUml.txt");
        fr =new FileWriter("RndExp/src/main/resources/myUml.txt",true);
    ...
    private void findAllFiles(){
        try (Stream<Path> walk = Files.walk(Paths.get(System.getProperty("user.dir")+"\\RndExp\\src\\main\\java"))) {
