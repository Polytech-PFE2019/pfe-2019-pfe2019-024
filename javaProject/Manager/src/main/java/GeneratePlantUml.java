...
public class GeneratePlantUml {
    ...
    public GeneratePlantUml() throws IOException {
        File file = new File("Manager/src/main/resources/myUml.txt");
        if (file.exists() && file.isFile())
        {
            file.delete();
        }
        file.createNewFile();
        file = new File("Manager/src/main/resources/myUml.txt");
        fr =new FileWriter("Manager/src/main/resources/myUml.txt",true);
